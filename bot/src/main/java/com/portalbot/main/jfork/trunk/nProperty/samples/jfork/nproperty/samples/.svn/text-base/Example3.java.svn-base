...
/**
 * Example of loading properties of primitive and standard types.
...
public class Example3
{
	...
	public Example3() throws NoSuchMethodException, InstantiationException, IllegalAccessException, IOException, InvocationTargetException
	{
		ConfigParser.parse(Example3.class, "config/example.ini");
	}

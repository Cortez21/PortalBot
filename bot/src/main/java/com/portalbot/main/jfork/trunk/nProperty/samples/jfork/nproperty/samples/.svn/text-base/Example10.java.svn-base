...
/**
 * Example of usage custom property names with nProperty.
...
public class Example10
{
	...
	public Example10() throws NoSuchMethodException, InstantiationException, IllegalAccessException, IOException, InvocationTargetException
	{
		ConfigParser.parse(Example10.class, "config/example.ini");
	}

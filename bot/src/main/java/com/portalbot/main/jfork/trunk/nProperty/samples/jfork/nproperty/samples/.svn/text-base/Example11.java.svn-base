...
/**
 * Example of usage dynamic objects with nProperty.
...
public class Example11
{
	...
	{
		ConfigParser.parse(Example11.class, "config/example.ini"); // At this call variable SOME_INT_VALUE will not be used by nProperty.

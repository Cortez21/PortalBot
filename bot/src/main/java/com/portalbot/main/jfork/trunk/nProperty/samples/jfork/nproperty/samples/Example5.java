...
/**
 * Example of using primitive arrays and custom splitters with nProperty.
...
{
	@Cfg(splitter = "--")
	private static int[] SOME_CUSTOM_INT_ARRAY;
	@Cfg(splitter = "[><]")
	private static short[] SOME_CUSTOM_SHORT_ARRAY;
	@Cfg
	private static BigInteger[] SOME_BIGINTEGER_ARRAY;

	public Example5() throws NoSuchMethodException, InstantiationException, IllegalAccessException, IOException, InvocationTargetException
	{
		ConfigParser.parse(Example5.class, "config/example.ini");
	}
